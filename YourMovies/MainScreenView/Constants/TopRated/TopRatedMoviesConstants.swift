//
//  TopRatedMoviesConstants.swift
//  TopRatedMoviesConstants
//
...
struct TopRatedMoviesConstants: MoviesConstantsProtocol {
    ...
    init(
        ...
        url = endpoints.mainApi + endpoints.topRatedMovies
    }
}
